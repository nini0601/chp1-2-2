...
lib.ssMetadata = [
		{name:"index_atlas_", frames: [[0,2296,400,400],[402,2296,400,400],[3088,1178,65,144],[3160,576,600,550],[2558,576,600,600],[0,1778,548,516],[0,742,548,516],[1316,682,548,516],[2200,2214,548,516],[3160,1128,548,516],[3516,1646,548,516],[550,742,548,516],[2416,1178,548,516],[2750,2164,548,516],[2200,1696,548,516],[3300,2164,548,516],[1650,1718,548,516],[1866,682,548,516],[1100,1200,548,516],[550,1778,548,516],[1100,1718,548,516],[0,1260,548,516],[2966,1646,548,516],[1100,2236,548,516],[550,1260,548,516],[1650,1200,548,516],[1650,2236,512,512],[2558,0,1149,574],[3088,1324,65,144],[0,0,1314,740],[3850,2164,220,55],[2416,682,74,321],[2966,1300,120,120],[2966,1422,120,120],[2966,1544,80,80],[2966,1178,120,120],[3850,2335,220,55],[3850,2449,220,55],[3850,2563,220,55],[3850,2278,220,55],[3850,2392,220,55],[804,2296,280,55],[3850,2506,220,55],[3850,2221,220,55],[804,2410,280,55],[3762,156,320,50],[3762,104,320,50],[3762,52,320,50],[3762,208,320,50],[3762,0,320,50],[804,2353,280,55],[1316,0,1240,680],[3048,1544,80,80],[2416,1005,120,120]]}
];
...
(lib.元件1 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["index_atlas_"],27), null, new cjs.Matrix2D(0.996,0,0,0.996,-572.2,-285.9)).s().p("EhZZAsqMAAAhZTMCyyAAAMAAABZTg");
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.frame_89 = function() {
		...
		*/
		...
		this.chp1.addEventListener("click", fl_ClickToGoToWebPage_5);
	...
	this.instance_23 = new lib.下一頁Button3();
	this.instance_23.parent = this;
	this.instance_23.setTransform(1680,841,0.535,0.535);

	this.instance_24 = new lib.元件1();
	this.instance_24.parent = this;
	this.instance_24.setTransform(1681.8,943.6,0.318,0.318,0,0,0,572.1,285.9);
	this.instance_24._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.next}]}).to({state:[{t:this.instance_23}]},7).to({state:[{t:this.instance_24}]},8).to({state:[{t:this.instance_24}]},12).to({state:[]},54).wait(9));
	this.timeline.addTween(cjs.Tween.get(this.instance_24).wait(15).to({_off:false},0).to({regY:285.8,scaleX:1.46,scaleY:1.46,x:955.6,y:603},12).to({_off:true},54).wait(9));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.chp11},{t:this.chp12},{t:this.chp2},{t:this.chp3},{t:this.chp21},{t:this.chp22},{t:this.chp111},{t:this.chp112},{t:this.chp31},{t:this.chp32},{t:this.chp33},{t:this.chp34},{t:this.chp35},{t:this.chp121},{t:this.chp1_1}]},89).wait(1));
	...
	this.instance_25 = new lib.chp22();
	this.instance_25.parent = this;
	this.instance_25.setTransform(962.4,590.6,1.464,1.464);
	new cjs.ButtonHelper(this.instance_25, 0, 1, 1);

	this.instance_26 = new lib.chp21();
	this.instance_26.parent = this;
	this.instance_26.setTransform(962.4,471.2,1.464,1.464);
	new cjs.ButtonHelper(this.instance_26, 0, 1, 1);

	this.instance_27 = new lib.chp35();
	this.instance_27.parent = this;
	this.instance_27.setTransform(1447.4,993,1.61,1.61);
	new cjs.ButtonHelper(this.instance_27, 0, 1, 1);

	this.instance_28 = new lib.chp34();
	this.instance_28.parent = this;
	this.instance_28.setTransform(1447.4,902.9,1.61,1.61);
	new cjs.ButtonHelper(this.instance_28, 0, 1, 1);

	this.instance_29 = new lib.chp33();
	this.instance_29.parent = this;
	this.instance_29.setTransform(1447.4,814.3,1.61,1.61);
	new cjs.ButtonHelper(this.instance_29, 0, 1, 1);

	this.instance_30 = new lib.chp32();
	this.instance_30.parent = this;
	this.instance_30.setTransform(1447.4,722.3,1.61,1.61);
	new cjs.ButtonHelper(this.instance_30, 0, 1, 1);

	this.instance_31 = new lib.chp31();
	this.instance_31.parent = this;
	this.instance_31.setTransform(1447.4,625.6,1.61,1.61);
	new cjs.ButtonHelper(this.instance_31, 0, 1, 1);

	this.instance_32 = new lib.chp122();
	this.instance_32.parent = this;
	this.instance_32.setTransform(1350.8,390.7,1.464,1.464);
	new cjs.ButtonHelper(this.instance_32, 0, 1, 1);

	this.instance_33 = new lib.chp121();
	this.instance_33.parent = this;
	this.instance_33.setTransform(1350.8,293.5,1.464,1.464);
	new cjs.ButtonHelper(this.instance_33, 0, 1, 1);

	this.instance_34 = new lib.chp12();
	this.instance_34.parent = this;
	this.instance_34.setTransform(961.4,330.1,1.464,1.464,0,0,0,-0.7,-0.6);
	new cjs.ButtonHelper(this.instance_34, 0, 1, 1);

	this.instance_35 = new lib.chp11();
	this.instance_35.parent = this;
	this.instance_35.setTransform(962.6,136.3,1.464,1.464,0,0,0,0.1,0.5);
	new cjs.ButtonHelper(this.instance_35, 0, 1, 1);

	this.instance_36 = new lib.chp112();
	this.instance_36.parent = this;
	this.instance_36.setTransform(1350.8,196.8,1.464,1.464);
	new cjs.ButtonHelper(this.instance_36, 0, 1, 1);

	this.instance_37 = new lib.chp111();
	this.instance_37.parent = this;
	this.instance_37.setTransform(1350.8,87.7,1.464,1.464);
	new cjs.ButtonHelper(this.instance_37, 0, 1, 1);

	this.instance_38 = new lib.ch3();
	this.instance_38.parent = this;
	this.instance_38.setTransform(529.4,835.1,1.464,1.464);
	new cjs.ButtonHelper(this.instance_38, 0, 1, 1);

	this.instance_39 = new lib.ch2();
	this.instance_39.parent = this;
	this.instance_39.setTransform(524,536.2,1.464,1.464);
	new cjs.ButtonHelper(this.instance_39, 0, 1, 1);

	this.instance_40 = new lib.現在位置_1();
	this.instance_40.parent = this;
	this.instance_40.setTransform(959.3,542,1.477,1.477,0,0,0,0,1.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_40},{t:this.instance_39},{t:this.instance_38},{t:this.instance_37},{t:this.instance_36},{t:this.instance_35},{t:this.instance_34},{t:this.instance_33},{t:this.instance_32},{t:this.instance_31},{t:this.instance_30},{t:this.instance_29},{t:this.instance_28},{t:this.instance_27},{t:this.instance_26},{t:this.instance_25},{t:this.chp1_2}]},84).to({state:[{t:this.instance_40},{t:this.instance_32}]},5).wait(1));

	// 小動畫bg
	this.instance_41 = new lib.U12背景();
	this.instance_41.parent = this;
	this.instance_41.setTransform(0,0,1.459,1.459);

	this.timeline.addTween(cjs.Tween.get(this.instance_41).to({_off:true},81).wait(3).to({_off:false},0).wait(6));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_.png?1482801237465", id:"index_atlas_"}
	],
	preloads: []
};
